...
from DenRoze3_models import Item, BillItem, Order, Bill, User, sqlite_mode, IDcreator
from DenRoze3_data_access_layer import Sqlite_db, Local_db
from pprint import pprint as pprint

class Reader_Writer_json:
    def init():
        Reader_Writer_json.local_db = Local_db()
    def write_changes(stock, bills, orders):
        Reader_Writer_json.local_db.write_changes(stock, bills, orders)
        for bill in bills:
...
class Reader_Writer:
    ...
    def create_database():
        Reader_Writer.sqlite_db.create_database()
